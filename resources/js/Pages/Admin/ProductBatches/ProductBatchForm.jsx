            ...
            <div className="relative" ref={dropdownRef}>
                ...
                <div className="relative mt-1.5">
                    ...
                    <input
                        ...
                        className={`block w-full rounded-xl py-2.5 pl-10 pr-4 text-sm shadow-sm transition focus:ring-2 ${errors.product_id ? 'border-red-300 focus:border-red-500 focus:ring-red-200' : 'border-border focus:border-ring focus:ring-ring/20'}`}
                    />
                    {selectedProduct && (
                                ...
                                dropdownProducts.map((p) => (
                                    <button
                                        ...
                                        className={`w-full rounded-lg px-3 py-2 text-left text-sm transition ${
                                            Number(data.product_id) === p.id ? 'bg-primary-50 font-semibold text-primary-700' : 'text-muted-foreground hover:bg-muted'
                                        }`}
                                    >
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                <div>
                    ...
                    <input
                        ...
                        className={`mt-1.5 block w-full rounded-xl font-mono text-sm shadow-sm transition focus:ring-2 ${errors.batch_no ? 'border-red-300 focus:border-red-500 focus:ring-red-200' : 'border-border focus:border-ring focus:ring-ring/20'}`}
                    />
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                <div>
                    ...
                    <input
                        ...
                        className={`mt-1.5 block w-full rounded-xl shadow-sm transition focus:ring-2 ${errors.quantity ? 'border-red-300 focus:border-red-500 focus:ring-red-200' : 'border-border focus:border-ring focus:ring-ring/20'}`}
                    />
                ...
                <div>
                    ...
                    <div className="relative mt-1.5">
                        ...
                        <input
                            ...
                            className={`block w-full rounded-xl pl-10 shadow-sm transition focus:ring-2 ${errors.cost_price ? 'border-red-300 focus:border-red-500 focus:ring-red-200' : 'border-border focus:border-ring focus:ring-ring/20'}`}
                        />
                    </div>
                    {data.product_id && (
