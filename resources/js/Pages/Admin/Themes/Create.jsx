...
export default function Create() {
    // Default token set diambil dari preset sistem pertama yang tersedia
    // (dari DB via ThemeProvider) — bukan hardcoded lagi.
    ...
    const { data, setData, post, processing, errors } = useForm({
        name: "",
        description: "",
        primary: defaultLight.primary || "#4F46E5",
        secondary: defaultLight.secondary || "#64748B",
        accent: defaultLight.accent || "#8B5CF6",
        is_dark: false,
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-lg font-semibold text-slate-800">Tambah Tema</h2>
                </div>
            }
        >
                    ...
                    <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                        <div className="border-b border-slate-100 bg-slate-50/60 px-6 py-5">
                            ...
                            <p className="mt-0.5 text-sm text-slate-500">
                                Buat tema custom dengan36 token warna. Preview update otomatis.
                            </p>
                        </div>
                        <div className="p-6">
                            <ThemeForm
