...
export default function Create({ categories: initialCategories }) {
 ...
 setQuickCatName('');
    ...
    const inputCls = 'block w-full rounded-xl border bg-white px-3 py-2.5 text-sm shadow-sm transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200';
                                        ...
                                        {!showQuickCat ? (
                                            ...
                                            <div className="flex items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 p-2">
                                                <input
                                                    ...
                                                    autoFocus
                                                    className="block flex-1 rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm shadow-sm transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200"
                                                    onKeyDown={(e) => {
                                                        if (e.key === 'Enter') {
                                                            e.preventDefault();
                                                            quickCreateCategory();
