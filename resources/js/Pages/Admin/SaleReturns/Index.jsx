                ...
                <div className="border-b border-border p-4">
                    ...
                    <div className="pt-4 flex items-center justify-between">
                        <p className="text-xs text-muted-foreground">
                            ...
                            dari{" "}
                            <span className="font-semibold text-foreground">{saleReturns.length}</span>{" "}
                            retur
                        </p>
                    </div>
                </div>
                    ...
                    <table className="min-w-full divide-y divide-border">
                        <thead className="bg-muted/50">
                            <tr>
                                ...
                                <th className="px-5 py-3.5 text-left text-xs font-semibold uppercase tracking-wider text-muted-foreground">Penjualan Asal</th>
                                <th className="px-5 py-3.5 text-left text-xs font-semibold uppercase tracking-wider text-muted-foreground">Pelanggan</th>
                            ...
                            {filtered.length === 0 ? (
                                ...
                                filtered.map((retur) => (
                                    <tr key={retur.id} className="transition hover:bg-muted/50">
                                        ...
                                        <td className="whitespace-nowrap px-5 py-4">
                                            <span className="text-sm text-muted-foreground">{retur.customer?.name || '-'}</span>
                                        </td>
                        ...
                        <div key={retur.id} className="rounded-2xl border border-border bg-card p-4 shadow-sm">
                            ...
                            <div className="mt-3 grid grid-cols-2 gap-2 text-xs">
                                <div>
                                    ...
                                    <p className="font-medium text-foreground">{retur.customer?.name || '-'}</p>
                                </div>
