...
export default function Edit({ group }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(route('admin.modifier-groups.update', group.id));
    };
        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center gap-3">
                    ...
                    <h2 className="text-lg font-semibold text-foreground">Edit Grup Modifier</h2>
                </div>
            }
        >
            ...
            <div className="mx-auto max-w-2xl">
                <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-sm">
                    <div className="border-b border-border bg-muted/50 px-6 py-5">
                        ...
                        <p className="mt-0.5 text-sm text-muted-foreground">Perbarui informasi grup modifier.</p>
                    </div>
