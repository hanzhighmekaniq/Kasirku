        ...
        <AuthenticatedLayout
            header={
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-lg font-semibold text-slate-800">Edit Supplier</h2>
                        <p className="text-sm text-slate-400">{supplier.name} <span className="text-xs text-slate-300">{supplier.code}</span></p>
                    </div>
                </div>
            }
        >
