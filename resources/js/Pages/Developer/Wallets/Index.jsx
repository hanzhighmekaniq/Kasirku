                ...
                <table className="w-full text-sm">
                    <thead className="bg-popover text-xs uppercase tracking-wide text-card-foreground">
                        <tr>
                            ...
                            <th className="px-5 py-3 text-right font-semibold">Saldo Tersedia</th>
                            <th className="px-5 py-3 text-right font-semibold">Pending</th>
                            <th className="px-5 py-3 text-right font-semibold">Sudah Ditarik</th>
                        ...
                        {wallets.length === 0 ? (
                            ...
                            wallets.map((w) => (
                                <tr key={w.id} className="transition hover:bg-[rgb(var(--color-table-hover))]">
                                    ...
                                    <td className="px-5 py-3 text-right font-semibold text-success">{fmt(w.balance)}</td>
                                    <td className="px-5 py-3 text-right text-warning">{fmt(w.pending_balance)}</td>
