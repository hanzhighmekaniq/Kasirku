        ...
        >
            ...
            <div className="mb-6 grid grid-cols-2 gap-4 lg:grid-cols-4">
                {statCards.map((s) => (
                    <div
                        key={s.label}
                        className="rounded-2xl border border-border bg-card text-card-foreground p-5 shadow-sm"
                    >
                        <div
            ...
            {storeTypes && Object.keys(storeTypes).length > 0 && (
                <div className="mb-5 rounded-2xl border border-border bg-card text-card-foreground p-5 shadow-sm">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {Object.entries(storeTypes).map(([type, count]) => {
                            ...
                            return (
                                ...
                                >
                                    <span>{tm.icon ?? <Building2 className="h-5 w-5" strokeWidth={1.8} />}</span>
                                    <span>{tm.label}</span>
                                    <span className="ml-1 rounded-full bg-card text-card-foreground/60 px-1.5 py-0.5 font-bold">
                                        {count}
                                    </span>
                                </span>
                            );
                        ...
                        {recentStores?.map((s) => {
                            ...
                            return (
                                <Link
                                    ...
                                    className="flex items-center justify-between px-5 py-3 transition hover:bg-muted"
                                >
            ...
            <div className="mt-5 grid grid-cols-2 gap-4 sm:grid-cols-4">
                {[
                    ...
                    <Link
                        key={a.label}
                        href={a.href}
                        className="flex items-center gap-3 rounded-xl border border-border bg-card text-card-foreground px-4 py-3 text-sm font-medium text-foreground shadow-sm transition hover:bg-muted hover:shadow-md"
                    >
                        <span
                            className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-lg ${a.color} text-primary-foreground`}
                        >
