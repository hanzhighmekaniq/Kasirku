...
class MembershipController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return back()->with('success', "Membership \"{$validated['name']}\" berhasil dibuat.");
    }
    ...
    public function update(Request $request, Membership $membership)
    {
        ...
        return back()->with('success', "Membership \"{$validated['name']}\" berhasil diperbarui.");
    }

    public function destroy(Membership $membership)
    {
        if ($membership->customerMemberships()->exists()) {
            return back()->with('error', 'Membership masih dipakai pelanggan. Nonaktifkan saja.');
        }
