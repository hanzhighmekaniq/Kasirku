...
/**
 * Tema & warna panel Developer — personal per-akun developer, bukan
 * konfigurasi platform. Preset sistem (is_system = true) hanya bisa dipakai,
 * tidak bisa diubah/dihapus dari sini; sumbernya tetap ThemePresetSeeder.
 *
 * Preset sistem sendiri sudah di-share ke semua halaman lewat
 * HandleInertiaRequests (page.props.systemThemes) dan dibaca ThemeProvider,
 * jadi controller ini cukup mengirim tema custom milik developer.
 */
class ThemeController extends Controller
{
    public function index(): Response
    {
        ...
        return Inertia::render('Developer/Themes/Index', [
    ...
    {
        return Inertia::render('Developer/Themes/Create');
    }
    ...
    public function edit(ThemePreset $theme): RedirectResponse|Response
    {
        ...
        return Inertia::render('Developer/Themes/Edit', [
            'theme' => $theme,
        ]);
    }
