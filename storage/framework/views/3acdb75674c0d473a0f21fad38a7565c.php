...
<head>
    ...
    <title>500 — Server Error — <?php echo e(config('app.name', 'SIM-KASIR')); ?></title>
...
<body class="bg-slate-100 min-h-screen flex">
    ...
    <div class="relative hidden w-1/2 overflow-hidden bg-gradient-to-br from-slate-900 via-indigo-950 to-violet-950 lg:flex lg:flex-col lg:justify-between xl:w-3/5">
        <div class="pointer-events-none absolute -left-24 -top-24 h-96 w-96 rounded-full bg-red-500/20 blur-3xl"></div>
        <div class="pointer-events-none absolute bottom-0 right-0 h-96 w-96 translate-x-1/3 translate-y-1/3 rounded-full bg-orange-500/20 blur-3xl"></div>
        ...
        <div class="relative z-10 flex flex-1 items-center justify-center">
            <div class="text-center">
                <div class="mx-auto mb-8 flex h-32 w-32 items-center justify-center rounded-3xl bg-white/5 backdrop-blur-sm ring-1 ring-white/10">
                    <svg class="h-16 w-16 text-red-400" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
                    </svg>
                </div>
                <h2 class="text-3xl font-bold text-white xl:text-4xl">Server Error</h2>
                <p class="mt-3 max-w-xs text-base text-slate-400">
                    Terjadi kesalahan pada server. Tim teknis sedang bekerja. Coba lagi nanti.
                </p>
            </div>
        </div>

        <div class="relative z-10 p-10 text-sm text-slate-400 xl:px-14">
            &copy; <?php echo e(date('Y')); ?> SIM-KASIR. All rights reserved.
        </div>
    </div>
        ...
        <div class="mx-auto w-full max-w-md">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-7 shadow-xl shadow-slate-200/60 sm:p-9">
                ...
                <p class="mt-3 text-center text-sm leading-relaxed text-slate-500">
                    Mohon maaf, terjadi kesalahan pada server. Silakan coba lagi beberapa saat.
                </p>
                ...
                <div class="rounded-xl bg-red-50 p-4">
                    <div class="flex gap-3">
                        ...
                        <div class="text-sm text-red-700">
                            <p class="font-medium">Apa yang bisa saya lakukan?</p>
                            <p class="mt-1 text-red-600/80">Coba refresh halaman atau kembali ke beranda. Jika masalah berlanjut, hubungi admin sistem.</p>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\HanzShadows\Kerja\Kasirku\resources\views\errors\500.blade.php ENDPATH**/ ?>