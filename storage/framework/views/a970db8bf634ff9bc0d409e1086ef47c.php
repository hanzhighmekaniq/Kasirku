...
<head>
    ...
    <title>404 — Tidak Ditemukan — <?php echo e(config('app.name', 'SIM-KASIR')); ?></title>
        ...
        <div class="mx-auto w-full max-w-md">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-7 shadow-xl shadow-slate-200/60 sm:p-9">
                ...
                <p class="mt-3 text-center text-sm leading-relaxed text-slate-500">
                    <?php echo e($exception->getMessage() ?: 'Halaman yang kamu cari tidak ditemukan.'); ?>
...
<?php /**PATH C:\HanzShadows\Kerja\Kasirku\resources\views\errors\404.blade.php ENDPATH**/ ?>