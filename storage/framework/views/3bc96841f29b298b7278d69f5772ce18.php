...
<head>
    ...
    <title>403 — Akses Ditolak — <?php echo e(config('app.name', 'SIM-KASIR')); ?></title>
        ...
        <div class="mx-auto w-full max-w-md">
            ...
            <div class="rounded-2xl border border-slate-200 bg-white p-7 shadow-xl shadow-slate-200/60 sm:p-9">
                ...
                <p class="mt-3 text-center text-sm leading-relaxed text-slate-500">
                    <?php echo e($exception->getMessage() ?: 'Role kamu tidak memiliki izin untuk mengakses halaman ini.'); ?>
                ...
                <div class="mt-7 flex flex-col gap-3">
                    ...
                    <form method="POST" action="<?php echo e(url('/logout')); ?>" style="display:block;width:100%;">
...
<?php /**PATH C:\HanzShadows\Kerja\Kasirku\resources\views\errors\403.blade.php ENDPATH**/ ?>