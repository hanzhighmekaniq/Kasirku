...
class CustomerSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // ── Store 1: Kopi Senja ───────────────────────────────────────
        Customer::firstOrCreate(['store_id' => $store1->id, 'code' => 'CST001'], [
            'name'            => 'Rina Marlina',
            'phone'           => '081300000001',
        ...
        Customer::firstOrCreate(['store_id' => $store1->id, 'code' => 'CST002'], [
            'name'            => 'Dedi Kurniawan',
            'phone'           => '081300000002',
        ...
        Customer::firstOrCreate(['store_id' => $store1->id, 'code' => 'CST003'], [
            'name'            => 'Maya Putri',
            'phone'           => '081300000003',
            'email'           => null,
            'birth_date'      => null,
        ...
        // ── Store 2: Minimarket ───────────────────────────────────────
        Customer::firstOrCreate(['store_id' => $store2->id, 'code' => 'CST001'], [
            'name'            => 'Fajar Nugroho',
            'phone'           => '081300000004',
        ...
        Customer::firstOrCreate(['store_id' => $store2->id, 'code' => 'CST002'], [
            'name'            => 'Ayu Lestari',
            'phone'           => '081300000005',
            'email'           => null,
            'birth_date'      => null,
        ...
        // ── Store 3: Barbershop ───────────────────────────────────────
        Customer::firstOrCreate(['store_id' => $store3->id, 'code' => 'CST001'], [
            'name'            => 'Hendra Wijaya',
            'phone'           => '081300000006',
        ...
        Customer::firstOrCreate(['store_id' => $store3->id, 'code' => 'CST002'], [
            'name'            => 'Bagas Pratama',
            'phone'           => '081300000007',
            'email'           => null,
        ...
        // ── Store 4: Laundry ──────────────────────────────────────────
        Customer::firstOrCreate(['store_id' => $store4->id, 'code' => 'CST001'], [
            'name'            => 'Rini Suryani',
            'phone'           => '081300000008',
        ...
        Customer::firstOrCreate(['store_id' => $store4->id, 'code' => 'CST002'], [
            'name'            => 'Yoga Pratama',
            'phone'           => '081300000009',
            'email'           => null,
            'birth_date'      => null,
