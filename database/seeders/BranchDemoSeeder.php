...
class BranchDemoSeeder extends Seeder
{
     ...
     */
    private function seedSales(int $storeId, int $branchId, int $kasirDewi): void
    {
        $sales = [
     ...
     */
    private function seedPurchases(int $storeId, int $branchId, int $owner1): void
    {
        $purchases = [
            [
                ...
                'user_id'       => $owner1,
                'items' => [
                    ['product_id' => 1, 'quantity' => 3, 'cost_price' => 120000],  // 3 kg Arabika (Pusat: 10kg)
     ...
     */
    private function seedExpenses(int $storeId, int $branchId, int $owner1): void
    {
        $expenses = [
            [
    ...
    private function seedStockMovements(int $storeId, int $branchId): void
    {
        ...
        foreach ($movements as $m) {
            StockMovement::create(array_merge($m, [
                'store_id'       => $storeId,
                'branch_id'      => $branchId,
                'reference_type' => null,
                'reference_id'   => null,
