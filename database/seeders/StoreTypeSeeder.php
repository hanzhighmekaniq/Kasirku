    ...
    public function run(): void
    {
        $types = [
            ...
            [
                ...
                "label" => "F&B",
                "icon" => "☕",
                "description" => "Restoran, cafe, bakery, fast food",
                "order_types" => [
                    ["v" => "dine_in", "l" => "Dine-in"],
            ...
            [
                ...
                "label" => "Service",
                "icon" => "✂️",
                "description" => "Salon, laundry, bengkel, jasa",
                "order_types" => [
            ...
            [
                ...
                "label" => "Rental",
                "icon" => "🔑",
                "description" => "Sewa alat, warnet, PS, karaoke",
                "order_types" => [
            ...
            [
                ...
                "label" => "Ticket",
                "icon" => "🎟️",
                "description" => "Bioskop, futsal, event, booking slot",
                "order_types" => [
            ...
            [
                ...
                "label" => "Hospitality",
                "icon" => "🏨",
                "description" => "Hotel, villa, penginapan, kost",
                "order_types" => [
        ...
        // Nonaktifkan tipe baru yang tidak dipakai (sisa dari versi 7-mode)
        StoreType::whereIn("code", ["laundry", "parking", "session"])->update([
            "is_active" => false,
        ]);
    }
}
