 ...
 *
 * Owner:
 *   owner@gmail.com  → Store 1 (Kopi Senja)   → Branch 1 + 2
...
class DemoDataSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $branch1 = Branch::where('store_id', $store1->id)->where('code', 'BR001')->firstOrFail();
        $branch2 = Branch::where('store_id', $store1->id)->where('code', 'BR002')->firstOrFail();
        $branch3 = Branch::where('store_id', $store2->id)->where('code', 'BR003')->firstOrFail();
        $branch4 = Branch::where('store_id', $store2->id)->where('code', 'BR004')->firstOrFail();
     ...
     */
    private function seedMinimarketBabarsariSales(int $storeId, int $branchId): void
    {
