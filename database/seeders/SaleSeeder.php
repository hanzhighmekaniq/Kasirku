...
class SaleSeeder extends Seeder
{
    ...
    {
        // Store 1 = Kopi Senja (cafe), Branch 1 = Pusat, Branch 2 = UGM
        ...
        $storeId = 1;
        $branchId = 1; // Kopi Senja Pusat

        // User lookups by email (agak fixed IDs)
        $andi = User::where("email", "kasir@gmail.com")->value("id");
        $dewi = User::where("email", "dewi@gmail.com")->value("id");
