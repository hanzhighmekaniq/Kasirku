...
class FeatureDetailSeeder extends Seeder
{
    private const DETAILS = [
        ...
        "sale_return" => [
            [
                "code" => "sreturn.view",
                "label" => "Lihat Retur Jual",
                "sort" => 1,
            ],
            [
                "code" => "sreturn.create",
                "label" => "Buat Retur Jual",
                "sort" => 2,
            ],
        ],
        ...
        "table" => [
            [
                "code" => "table.view",
                "label" => "Lihat Denah Meja",
                "sort" => 1,
            ],
            ["code" => "table.manage", "label" => "Atur Meja", "sort" => 2],
            [
                "code" => "table.assign",
                "label" => "Assign Pesanan",
                "sort" => 3,
            ],
        ],
        ...
        "kitchen" => [
            [
                "code" => "kitchen.display",
                "label" => "Display Pesanan",
                "sort" => 1,
            ],
            [
                "code" => "kitchen.update",
        ...
        "commission" => [
            ...
            [
                "code" => "commission.approve",
                "label" => "Approve Komisi",
                "sort" => 2,
            ],
        ],
        ...
        "modifier" => [
            [
                "code" => "modifier.view",
                "label" => "Lihat Modifier",
                "sort" => 1,
            ],
            [
                "code" => "modifier.create",
            ...
            [
                "code" => "modifier.delete",
                "label" => "Hapus Modifier",
                "sort" => 4,
            ],
        ],
        ...
        "payment_method" => [
            [
                "code" => "paymethod.view",
                "label" => "Lihat Metode Bayar",
                "sort" => 1,
            ],
            [
                "code" => "paymethod.edit",
                "label" => "Atur Metode Bayar",
                "sort" => 2,
            ],
        ],
        ...
        "settings" => [
            [
                "code" => "setting.general",
                "label" => "Pengaturan Umum",
                "sort" => 1,
            ],
            [
                "code" => "setting.receipt",
                "label" => "Pengaturan Nota",
                "sort" => 2,
            ],
            [
                "code" => "setting.tax",
