...
class PurchaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $owner1 = User::where('email', 'owner@gmail.com')->value('id');
        ...
        $purchases = [
            ...
            [
                ...
                'user_id' => $owner1,
                'items' => [
                    ['product_id' => 1, 'quantity' => 10, 'cost_price' => 120000], // 10 kg Arabika
            ...
            [
                ...
                'user_id' => $owner1,
                'items' => [
                    ['product_id' => 3, 'quantity' => 20, 'cost_price' => 18000], // 20L Susu Fresh
                    ['product_id' => 4, 'quantity' => 10, 'cost_price' => 22000], // 10L Susu Evap
                ],
                'paid_amount' => 580000,
            ...
            [
                ...
                'user_id' => $owner1,
                'items' => [
                    ['product_id' => 5, 'quantity' => 10, 'cost_price' => 14000], // 10kg Gula
                    ['product_id' => 9, 'quantity' => 30, 'cost_price' => 2200],   // 30kg Telur
                    ['product_id' => 11, 'quantity' => 20, 'cost_price' => 8000],  // 20kg Nasi
                ],
                'paid_amount' => 346000,
                'payment_method_id' => 1,
            ],
            ...
            [
                ...
                'user_id' => $owner2,
                'items' => [
                    ['product_id' => 25, 'quantity' => 100, 'cost_price' => 2500],  // 100 Indomie
                    ['product_id' => 26, 'quantity' => 48, 'cost_price' => 3500],   // 48 Teh Botol
                    ['product_id' => 27, 'quantity' => 60, 'cost_price' => 3000],   // 60 Aqua
                    ['product_id' => 32, 'quantity' => 60, 'cost_price' => 2000],   // 60 Kopi Torabika
                ],
                'paid_amount' => 756000,
                'payment_method_id' => 3,
            ],
            [
                ...
                'user_id' => $owner2,
                'items' => [
                    ['product_id' => 28, 'quantity' => 15, 'cost_price' => 55000],  // 15 Beras 5kg
                    ['product_id' => 29, 'quantity' => 20, 'cost_price' => 14000],  // 20 Minyak 1L
                    ['product_id' => 30, 'quantity' => 25, 'cost_price' => 12000],  // 25 Gula 1kg
                    ['product_id' => 31, 'quantity' => 24, 'cost_price' => 8000],   // 24 Susu Kental
                ],
                'paid_amount' => 1573000,
                'payment_method_id' => 3,
            ],
            ...
            [
                ...
                'user_id' => $owner2,
                'items' => [
                    ['product_id' => 25, 'quantity' => 30, 'cost_price' => 2500],   // 30 Indomie
                    ['product_id' => 27, 'quantity' => 24, 'cost_price' => 3000],   // 24 Aqua
                ],
                'paid_amount' => 147000,
                'payment_method_id' => 1,
            ],
