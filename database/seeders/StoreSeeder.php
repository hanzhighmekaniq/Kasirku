...
class StoreSeeder extends Seeder
{
    ...
    {
        // Store 1 — Warung Kopi Senja (FnB)
        Store::firstOrCreate(['code' => 'STORE001'], [
            'name'             => 'Warung Kopi Senja',
            'store_type'       => 'fnb',
            'modules'          => [
                'pos_modes' => ['fnb'],
                'features'  => ['stock', 'purchase', 'recipe', 'modifier', 'table', 'kitchen', 'waste', 'promo', 'delivery', 'booking', 'sale_return', 'report', 'payment_gateway', 'stock_opname'],
            ],
            'plan'             => 'basic',
            'max_users'        => 5,
            'max_branches'     => 3,
            ...
            'receipt_footer'   => 'Terima kasih telah berkunjung! ☕ Kopi Senja © 2026',
            'is_active'        => true,
        ]);

        // Store 2 — Minimarket Sejahtera (Retail)
        Store::firstOrCreate(['code' => 'STORE002'], [
            'name'             => 'Minimarket Sejahtera',
            'store_type'       => 'retail',
            'modules'          => [
                'pos_modes' => ['retail'],
                'features'  => ['stock', 'purchase', 'batch', 'expiry', 'promo', 'sale_return', 'report', 'payment_gateway', 'stock_opname'],
            ],
            'plan'             => 'basic',
            'max_users'        => 5,
            'max_branches'     => 3,
            ...
            'receipt_footer'   => 'Belanja hemat, hidup sejahtera! 🛒 Sejahtera © 2026',
            'is_active'        => true,
        ]);

        // Store 3 — Barbershop Rapi (Service)
        Store::firstOrCreate(['code' => 'STORE003'], [
            'name'             => 'Barbershop Rapi',
            'store_type'       => 'service',
            'modules'          => [
                'pos_modes' => ['service'],
                'features'  => ['queue', 'booking', 'commission', 'membership', 'deposit', 'promo', 'report', 'payment_gateway'],
            ],
            'plan'             => 'basic',
            'max_users'        => 5,
            'max_branches'     => 3,
        ...
        // Store 4 — Laundry Bersih → sekarang Service (laundry adalah sub-tipe service)
        Store::firstOrCreate(['code' => 'STORE004'], [
            'name'             => 'Laundry Bersih',
            'store_type'       => 'service',
            'modules'          => [
                'pos_modes' => ['service'],
                'features'  => ['queue', 'membership', 'deposit', 'promo', 'report', 'payment_gateway'],
            ],
            'plan'             => 'basic',
            'max_users'        => 5,
            'max_branches'     => 3,
            ...
            'receipt_header'   => 'Laundry Bersih',
            'receipt_footer'   => 'Bersih, wangi, tepat waktu! 👕',
            'is_active'        => true,
        ]);

        // Store 5 — Futsal Merdeka (Ticket / Booking slot)
        Store::firstOrCreate(['code' => 'STORE005'], [
            'name'             => 'Futsal Merdeka',
            'store_type'       => 'ticket',
            'modules'          => [
                'pos_modes' => ['ticket'],
        ...
        Store::firstOrCreate(['code' => 'STORE006'], [
            'name'             => 'Villa Sunrise',
            'store_type'       => 'hospitality',
            'modules'          => [
                'pos_modes' => ['hospitality'],
                'features'  => ['booking', 'membership', 'deposit', 'report', 'payment_gateway'],
            ],
            'plan'             => 'basic',
            'max_users'        => 5,
            'max_branches'     => 3,
