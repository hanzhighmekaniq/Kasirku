...
class DevSeeder extends Seeder
{
    ...
    private function seedStoreTypes(): void
    {
        $types = [
            [
                ...
                "pb" => "retail",
                "sort" => 1,
                "desc" => "Toko, minimarket, grosir, apotek",
                "ot" => [
                    ["v" => "takeaway", "l" => "Ambil"],
                    ["v" => "delivery", "l" => "Antar"],
            ...
            [
                ...
                "pb" => "fnb",
                "sort" => 2,
                "desc" => "Restoran, cafe, bakery, warteg",
                "ot" => [
                    ["v" => "dine_in", "l" => "Dine-in"],
            ...
            [
                ...
                "pb" => "service",
                "sort" => 3,
                "desc" => "Salon, barbershop, bengkel, spa",
                "ot" => [
            ...
            [
                ...
                "pb" => "rental",
                "sort" => 4,
                "desc" => "Sewa alat, kendaraan, kamera",
                "ot" => [
            ...
            [
                ...
                "pb" => "ticket",
                "sort" => 5,
                "desc" => "Bioskop, futsal, event, konser",
                "ot" => [
            ...
            [
                ...
                "pb" => "hospitality",
                "sort" => 6,
                "desc" => "Hotel, villa, kost, guest house",
                "ot" => [
            ...
            [
                ...
                "pb" => "session",
                "sort" => 8,
                "desc" => "Warnet, rental PS, karaoke, billiard",
                "ot" => [
                    ["v" => "per_hour", "l" => "Per Jam"],
                    ["v" => "per_minute", "l" => "Per Menit"],
                    ["v" => "flat", "l" => "Flat"],
                ],
            ],
        ];
    ...
    private function seedPlans(): void
    {
        Plan::updateOrCreate(
            ...
            [
                "label" => "Free",
                "description" => "Gratis untuk pemula.",
                "max_users" => 1,
                "max_branches" => 1,
                "price" => 0,
                "trial_days" => 0,
        ...
        Plan::updateOrCreate(
            ...
            [
                "label" => "Pro",
                "description" => "Premium, all unlock.",
                "max_users" => 999,
                "max_branches" => 999,
                "price" => 499000,
                "trial_days" => 7,
    ...
    //     }
    //     if ($basic) {
    //         $basic->planFeatures()->sync(Feature::pluck("id"));
    //     }
    //     if ($pro) {
