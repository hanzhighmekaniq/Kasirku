    ...
    public function run(): void
    {
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Indomie Goreng",
                "description" =>
                    "Mie instan goreng rasa ayam bawang, 85gr per bungkus.",
                "type" => "finished_goods",
                "unit" => "pcs",
                "cost_price" => 2800,
                "sell_price" => 4000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "description" =>
                    "Beras putih premium varietas Rojolele, kemasan 5kg.",
                "type" => "finished_goods",
                "unit" => "pcs",
                "cost_price" => 60000,
                "sell_price" => 72000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "description" =>
                    "Espresso shot dengan susu fresh dan gula aren asli.",
                "type" => "finished_goods",
                "preparation_time" => 5,
                "unit" => "pcs",
                "cost_price" => 8000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Americano",
                "description" =>
                    "Espresso double shot dengan air panas, rasa kopi kuat.",
                "type" => "finished_goods",
                "preparation_time" => 3,
                "unit" => "pcs",
                "cost_price" => 5000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Matcha Latte",
                "description" =>
                    "Matcha premium Jepang dengan susu segar dan sedikit pemanis.",
                "type" => "finished_goods",
                "preparation_time" => 5,
                "unit" => "pcs",
                "cost_price" => 9000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "description" =>
                    "Croissant lembut berlapis mentega, dipanggang fresh setiap hari.",
                "type" => "finished_goods",
                "preparation_time" => 2,
                "unit" => "pcs",
                "cost_price" => 8000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "description" =>
                    "Nasi goreng dengan telur, ayam suwir, kerupuk, dan acar.",
                "type" => "finished_goods",
                "preparation_time" => 10,
                "unit" => "pcs",
                "cost_price" => 10000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "description" =>
                    "Roti tawar panggang dengan selai coklat dan margarin.",
                "type" => "finished_goods",
                "preparation_time" => 5,
                "unit" => "pcs",
                "cost_price" => 5000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "description" =>
                    "Potong rambut + blow dry + sisir. Termasuk konsultasi gaya.",
                "type" => "service",
                "unit" => "kunjungan",
                "cost_price" => 10000,
                "sell_price" => 35000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Potong + Keramas",
                "description" =>
                    "Potong rambut, keramas, kondisioner, dan blow dry.",
                "type" => "service",
                "unit" => "kunjungan",
                "cost_price" => 18000,
                "sell_price" => 55000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Cukur Jenggot",
                "description" =>
                    "Pencukuran jenggot rapi dengan pisau cukur dan foam.",
                "type" => "service",
                "unit" => "kunjungan",
                "cost_price" => 8000,
                "sell_price" => 25000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Cat Rambut",
                "description" =>
                    "Cat rambut pilihan warna, termasuk kondisioner pasca pewarnaan.",
                "type" => "service",
                "unit" => "kunjungan",
                "cost_price" => 60000,
                "sell_price" => 150000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "description" =>
                    "Perawatan rambut intensif dengan masker protein dan steam.",
                "type" => "service",
                "unit" => "kunjungan",
                "cost_price" => 30000,
                "sell_price" => 75000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "description" =>
                    "Tenda camping waterproof kapasitas 4 orang, lengkap dengan tiang dan pasak.",
                "type" => "rental_item",
                "unit" => "unit",
                "cost_price" => 30000,
                "sell_price" => 75000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Matras Camping",
                "description" =>
                    "Matras tidur lipat untuk camping, ringan dan tahan lembab.",
                "type" => "rental_item",
                "unit" => "unit",
                "cost_price" => 8000,
                "sell_price" => 25000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "description" =>
                    "Kompor gas portable single burner untuk camping dan outdoor.",
                "type" => "rental_item",
                "unit" => "unit",
                "cost_price" => 10000,
                "sell_price" => 30000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "description" =>
                    "Kamera DSLR Canon EOS 2000D dengan lensa kit 18-55mm, tas, dan baterai cadangan.",
                "type" => "rental_item",
                "unit" => "unit",
                "cost_price" => 50000,
                "sell_price" => 150000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Sepeda Gunung",
                "description" =>
                    "Sepeda gunung 21-speed, cocok untuk trek alam dan perkotaan.",
                "type" => "rental_item",
                "unit" => "unit",
                "cost_price" => 20000,
                "sell_price" => 50000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Tiket Reguler",
                "description" =>
                    "Tiket bioskop reguler, kursi non-VIP dengan kenyamanan standar.",
                "type" => "time_based",
                "unit" => "tiket",
                "cost_price" => 15000,
                "sell_price" => 50000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Tiket VIP",
                "description" =>
                    "Kursi VIP dengan tempat duduk premium, recliner, dan snack gratis.",
                "type" => "time_based",
                "unit" => "tiket",
                "cost_price" => 30000,
                "sell_price" => 85000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Tiket Couple",
                "description" =>
                    "Sofa couple 2 kursi berdampingan, cocok untuk pasangan.",
                "type" => "time_based",
                "unit" => "pasang",
                "cost_price" => 50000,
                "sell_price" => 150000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "description" =>
                    "Tiket khusus anak usia di bawah 12 tahun, film rating SU.",
                "type" => "time_based",
                "unit" => "tiket",
                "cost_price" => 10000,
                "sell_price" => 35000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Kamar Standard",
                "description" =>
                    "Kamar AC, 1 kasur double, kamar mandi dalam, TV 32 inci, dan sarapan.",
                "type" => "time_based",
                "unit" => "malam",
                "cost_price" => 120000,
                "sell_price" => 350000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Kamar Deluxe",
                "description" =>
                    "Kamar AC luas, 1 kasur king, balkon dengan view taman, dan minibar.",
                "type" => "time_based",
                "unit" => "malam",
                "cost_price" => 200000,
                "sell_price" => 500000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Villa Family",
                "description" =>
                    "Villa 3 kamar tidur, dapur lengkap, ruang keluarga, dan kolam renang pribadi.",
                "type" => "time_based",
                "unit" => "malam",
                "cost_price" => 450000,
                "sell_price" => 1200000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Suite Room",
                "description" =>
                    "Suite premium dengan bathtub, sofa lounge, minibar, dan view pegunungan.",
                "type" => "time_based",
                "unit" => "malam",
                "cost_price" => 300000,
                "sell_price" => 800000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Parkir Motor",
                "description" =>
                    "Tarif parkir sepeda motor per transaksi masuk-keluar.",
                "type" => "time_based",
                "unit" => "kendaraan",
                "cost_price" => 0,
                "sell_price" => 3000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Parkir Mobil",
                "description" =>
                    "Tarif parkir mobil per transaksi masuk-keluar.",
                "type" => "time_based",
                "unit" => "kendaraan",
                "cost_price" => 0,
                "sell_price" => 5000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "description" =>
                    "Tarif parkir kendaraan besar (truk dan bus) per transaksi.",
                "type" => "time_based",
                "unit" => "kendaraan",
                "cost_price" => 0,
                "sell_price" => 10000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Paket 1 Jam",
                "description" =>
                    "Akses 1 jam ke semua fasilitas warnet dan konsol PS.",
                "type" => "time_based",
                "unit" => "sesi",
                "cost_price" => 2000,
                "sell_price" => 8000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Paket 2 Jam",
                "description" =>
                    "Akses 2 jam ke semua fasilitas, hemat dibanding beli per jam.",
                "type" => "time_based",
                "unit" => "sesi",
                "cost_price" => 4000,
                "sell_price" => 15000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Paket 5 Jam",
                "description" =>
                    "Akses 5 jam non-stop, cocok untuk marathon gaming.",
                "type" => "time_based",
                "unit" => "sesi",
                "cost_price" => 10000,
                "sell_price" => 35000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Paket Malam",
                "description" =>
                    "Paket overnight 8 jam mulai pukul 22:00, harga spesial.",
                "type" => "time_based",
                "unit" => "sesi",
                "cost_price" => 8000,
                "sell_price" => 25000,
        ...
        Product::firstOrCreate(
            ...
            [
                ...
                "name" => "Member Harian",
                "description" =>
                    "Akses unlimited 1 hari penuh, bebas keluar masuk.",
                "type" => "time_based",
                "unit" => "hari",
                "cost_price" => 20000,
                "sell_price" => 50000,
